        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CERTIFICATIONS.map((cert, idx) => (
            <motion.div
              ...
              className="group glass-panel p-6 rounded-3xl relative flex flex-col justify-between border border-border/80 hover:border-blue-500/50 hover:shadow-xl transition-all duration-300"
            >
              <div>
              ...
              <div className="pt-4 border-t border-border/40">
                <a
                  ...
                  className="flex items-center justify-center gap-1.5 w-full py-2.5 rounded-xl bg-blue-600 text-white text-xs font-semibold hover:bg-blue-700 dark:hover:bg-blue-500 transition-colors shadow-md shadow-blue-500/20"
                >
