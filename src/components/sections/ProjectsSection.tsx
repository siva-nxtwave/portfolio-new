...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="py-24 relative z-10 bg-slate-50/50 dark:bg-slate-900/30">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl glass-panel text-xs border border-border focus:outline-none focus:border-blue-500 transition-colors"
            />
          </div>
        </div>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div>
                ...
                <div className="relative h-48 bg-gradient-to-br from-blue-900/40 via-slate-900 to-sky-950/40 p-6 flex flex-col justify-between overflow-hidden">
          ...
          {selectedProject && (
            ...
            >
              ...
              >
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold mb-2">{selectedProject.title}</h3>
                <p className="text-sm text-slate-500 mb-6">{selectedProject.subtitle}</p>
                    ...
                    <div className="flex gap-2">
                      {selectedProject.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-2 px-4 py-2 rounded-xl glass-panel text-xs font-semibold hover:bg-slate-200 dark:hover:bg-slate-800"
                        >
                          <GitPullRequest className="w-4 h-4" />
