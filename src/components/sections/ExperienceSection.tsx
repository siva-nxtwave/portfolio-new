              ...
              return (
                ...
                >
                  ...
                  <div className="w-full sm:w-[calc(50%-2.5rem)] ml-12 sm:ml-0">
                    <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-border hover:border-blue-500/50 hover:shadow-xl transition-all duration-300">
                      ...
                      <div className="flex items-center gap-3 text-xs text-slate-600 dark:text-slate-400 font-medium mb-4">
                        <span className="text-blue-500 font-semibold">{item.company}</span>
                        <span>•</span>
                      ...
                      {item.achievements.length > 0 && (
                        <div className="pt-4 border-t border-border/60 mb-4">
                          <span className="block text-[10px] font-mono text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-1">
                            <Award className="w-3 h-3 text-amber-400" /> Key Impact Highlights
                          </span>
