...
export function AboutSection() {
  return (
    <section id="about" className="py-24 relative z-10 bg-slate-50/50 dark:bg-slate-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <motion.div
            ...
            className="lg:col-span-7 glass-panel p-8 rounded-3xl relative overflow-hidden"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-border/60">
              ...
              <div className="flex gap-4">
                <div className="p-3 bg-blue-600/10 text-blue-500 rounded-2xl h-fit">
                  <Target className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-800 dark:text-slate-200 mb-1">My Mission</h4>
              ...
              {/* Vision Card */}
              <div className="flex gap-4">
                <div className="p-3 bg-sky-500/10 text-sky-500 rounded-2xl h-fit">
                  <Compass className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-800 dark:text-slate-200 mb-1">My Vision</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          ...
          >
            <div className="glass-panel p-6 rounded-3xl flex flex-col justify-between hover:border-blue-500/50 transition-all">
              <div className="p-3 bg-blue-600/10 text-blue-500 rounded-2xl w-fit mb-4">
                <Briefcase className="w-6 h-6" />
              </div>
              <div>
                <span className="text-2xl font-extrabold text-slate-900 dark:text-white">Royal Enfield</span>
                <span className="block text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Procurement Trainee</span>
              </div>
            </div>

            <div className="glass-panel p-6 rounded-3xl flex flex-col justify-between hover:border-sky-500/50 transition-all">
              <div className="p-3 bg-sky-500/10 text-sky-500 rounded-2xl w-fit mb-4">
                <GraduationCap className="w-6 h-6" />
              </div>
              <div>
                <span className="text-2xl font-extrabold text-slate-900 dark:text-white">B.Sc. Physics</span>
                <span className="block text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">H.H. The Rajah&apos;s College</span>
              </div>
            </div>

            <div className="glass-panel p-6 rounded-3xl flex flex-col justify-between hover:border-cyan-500/50 transition-all">
              <div className="p-3 bg-cyan-500/10 text-cyan-500 rounded-2xl w-fit mb-4">
                <Code className="w-6 h-6" />
              </div>
              <div>
                <span className="text-2xl font-extrabold text-slate-900 dark:text-white">Full-Stack</span>
            ...
            <div className="glass-panel p-6 rounded-3xl flex flex-col justify-between hover:border-blue-500/50 transition-all">
              ...
              <div>
                <span className="text-2xl font-extrabold text-slate-900 dark:text-white">Gemini + Mobile</span>
        ...
        <div className="glass-panel p-8 rounded-3xl border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {PERSONAL_INFO.strengths.map((str, idx) => (
              <div key={idx} className="flex items-start gap-3 p-4 rounded-2xl bg-slate-100/70 dark:bg-slate-800/50">
