...
import { User, Target, Compass, Sparkles, Code, Award, CheckCircle2, Briefcase, GraduationCap } from "lucide-react";
import { PERSONAL_INFO } from "@/lib/data";

export function AboutSection() {
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 relative z-10 bg-slate-100/40 dark:bg-slate-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <motion.div
            ...
            className="lg:col-span-7 glass-panel p-5 sm:p-8 rounded-3xl relative overflow-hidden border border-border/80"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 pt-4 border-t border-border/60">
              {/* Mission Card */}
              <div className="flex gap-4">
                <div className="p-3 bg-blue-600/10 text-blue-600 dark:text-blue-400 rounded-2xl h-fit shrink-0">
              ...
              {/* Vision Card */}
              <div className="flex gap-4">
                <div className="p-3 bg-sky-500/10 text-sky-600 dark:text-sky-400 rounded-2xl h-fit shrink-0">
          ...
          <motion.div
            ...
            className="lg:col-span-5 grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4"
          >
            <div className="glass-panel p-4 sm:p-6 rounded-3xl flex flex-col justify-between border border-border/80 hover:border-blue-500/50 hover:shadow-lg transition-all">
              <div className="p-3 bg-blue-600/10 text-blue-600 dark:text-blue-400 rounded-2xl w-fit mb-4">
                <Briefcase className="w-6 h-6" />
              </div>
              <div>
                <span className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white">Royal Enfield</span>
                <span className="block text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Procurement Trainee</span>
              </div>
            </div>

            <div className="glass-panel p-4 sm:p-6 rounded-3xl flex flex-col justify-between border border-border/80 hover:border-sky-500/50 hover:shadow-lg transition-all">
              <div className="p-3 bg-sky-500/10 text-sky-600 dark:text-sky-400 rounded-2xl w-fit mb-4">
                <GraduationCap className="w-6 h-6" />
              </div>
              <div>
                <span className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white">B.Sc. Physics</span>
                <span className="block text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">H.H. The Rajah&apos;s College</span>
              </div>
            </div>

            <div className="glass-panel p-4 sm:p-6 rounded-3xl flex flex-col justify-between border border-border/80 hover:border-cyan-500/50 hover:shadow-lg transition-all">
              <div className="p-3 bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 rounded-2xl w-fit mb-4">
                <Code className="w-6 h-6" />
              </div>
              <div>
                <span className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white">Full-Stack</span>
                <span className="block text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">NxtWave Coursework</span>
              </div>
            </div>

            <div className="glass-panel p-4 sm:p-6 rounded-3xl flex flex-col justify-between border border-border/80 hover:border-emerald-500/50 hover:shadow-lg transition-all">
              <div className="p-3 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-2xl w-fit mb-4">
                <Sparkles className="w-6 h-6" />
              </div>
              <div>
                <span className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-white">Gemini + Mobile</span>
